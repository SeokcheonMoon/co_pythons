...
class Question_Answer:
    ...
    def __init__(self, problems, correct_answers):
        self.problems = problems    # hint                                         좌우에 self.를 붙임
        self.correct_answers = correct_answers     # hint                          좌우에 self.를 붙임
    ...
    def problems_main(self):
        ...
        for question in range(4):    # hint                             반복을 네번해야하므로 1을 4로 수정
...
class Statistics:
    ...
    def total_responses(self, input_temp):    # 점수 합계 출력
        ...
        self.score = score                                                                     #self.score 변수를 만들어 score점수를 받음 -> 다음 function에서 사용하기 위함
        self.credit_result()
...
if __name__ == "__main__":
    ...
    question_answer = Question_Answer(list_problems,list_corrects)    # hint               괄호에 list corrects를 추가
