...
def problems_main(questions) :      # hint------------------def problems_m(questions)  *(완료)
    ...
    #각 그룹에서 질문 가져옴
    for question in list_problems:       # hint-----------------------for question in []: 
    ...
    def total_responses(score):
        ...
        if score >= 30:
            score_result = "A"
        elif score >= 20:       # hint-----------------------------------else score >= 20: *(완료)
            score_result = "B"
        else:
            score_result = "F"
...
if __name__ == "__main__":
    ...
    list_problems = [
            ...
            '1) var name 2) name = value 3) set name 4) name == value'           #------------------------------------------보기 추가 *(완료)
    ...
    # 문제 당 정답
    list_corrects = [1,0,0,3]    # hint-----------------------------list_corrects = [2, 1, ] *(완료) 애매
